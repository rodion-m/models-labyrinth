...
| Business and professional work | Read the domain route in `references/business-domain-playbook.md`; prefer an exact workflow benchmark over a broad occupational aggregate | Deliverable, applications/tools, policy state, jurisdiction, evaluation harness, strict versus partial success, privacy, auditability, and human-review requirements |
...
For finance, legal, healthcare, education, public services, office work, SaaS automation, customer service, HR, IT operations, cybersecurity, or software modernization, read [references/business-domain-playbook.md](references/business-domain-playbook.md). It defines the closest current benchmark route and, equally importantly, which adjacent business claims that evidence does not support.
